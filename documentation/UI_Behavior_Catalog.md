...
| [Loading states](#loading-states) | 13 |
...
| Security | copies: `log.username` | `frontend/app.js:990` (renderNetfilterData) |
| Security | copies: `src.ip` | `frontend/app.js:1176` (renderSecurityOverview) |
| Security | copies: `row.ip` | `frontend/app.js:1198` (renderSecurityOverview) |
| Security | copies: `row.username` | `frontend/app.js:1199` (renderSecurityOverview) |
| Queue | copies: `r.email` | `frontend/app.js:2558` (applyQueueFilters) |
| Queue | copies: `item.sender` | `frontend/app.js:2559` (applyQueueFilters) |
| Queue | copies: `qid` | `frontend/app.js:2559` (applyQueueFilters) |
| Quarantine | copies: `item.sender \|\| 'Unknown'` | `frontend/app.js:2852` (renderQuarantineData) |
| Quarantine | copies: `item.qid` | `frontend/app.js:2852` (renderQuarantineData) |
| Quarantine | copies: `item.rcpt \|\| 'Unknown'` | `frontend/app.js:2854` (renderQuarantineData) |
| Quarantine | copies: `r.address` | `frontend/app.js:3058` (renderQuarantineDetailContent) |
| Quarantine | copies: `data.subject \|\| '-'` | `frontend/app.js:3086` (renderQuarantineDetailContent) |
| Quarantine | copies: `data.header_from \|\| '-'` | `frontend/app.js:3087` (renderQuarantineDetailContent) |
| Quarantine | copies: `data.env_from \|\| '-'` | `frontend/app.js:3088` (renderQuarantineDetailContent) |
| Spam filter | copies: `displayEmail` | `frontend/spam_filter.js:428` (renderSuppressionItem) |
| Status | copies: `item.message_id \|\| 'N/A'` | `frontend/app.js:4326` (renderStatusCorrelation) |
| Status | copies: `item.sender \|\| 'N/A'` | `frontend/app.js:4327` (renderStatusCorrelation) |
| Status | copies: `item.recipient \|\| 'N/A'` | `frontend/app.js:4327` (renderStatusCorrelation) |
| Shared | copies: `ip` | `frontend/app.js:4539` (renderGeoIPInfo) |
| Shared | copies: `ip` | `frontend/app.js:4546` (renderGeoIPInfo) |
...
| Shell | set in JS: dynamic: ``Update available: ${data.latest_version}`` | `frontend/app.js:703` (loadMailcowVersionStatus) |
| Shell | set in JS: dynamic: ``Update available: ${data.latest_version}`` | `frontend/app.js:710` (loadMailcowVersionStatus) |
| Dashboard | "Dismiss" | `frontend/app.js:1605` (loadDashboardSecurityAlerts) |
| Dashboard | dynamic: `${hour(s.t)}: ${s.clean.toLocaleString()} clean, ${s.spam.toLocaleString()} spam` | `frontend/app.js:1719` (loadMailFlowChart) |
| Dashboard | dynamic: `Running ${containers.running \|\| 0}, Stopped ${containers.stopped \|\| 0}, T...` | `frontend/app.js:1761` (loadDashboardStatusSummary) |
| Dashboard | dynamic: `Available ${storage.used \|\| '0'} / ${storage.total \|\| '0'}` | `frontend/app.js:1771` (loadDashboardStatusSummary) |
| Dashboard | dynamic: `${escapeHtml(formatTime(msg.time))}` | `frontend/app.js:1814` (loadRecentActivity) |
| Dashboard | dynamic: `${escapeHtml(state)}` | `frontend/app.js:1815` (loadRecentActivity) |
| Dashboard | dynamic: `${escapeHtml(msg.subject \|\| 'No subject')}` | `frontend/app.js:1817` (loadRecentActivity) |
| Dashboard | "The first check runs automatically" | `frontend/app.js:4190` (loadDashboardBlacklistSummary) |
| Messages | dynamic: `${escapeHtml(formatTime(msg.first_seen))}` | `frontend/app.js:865` (renderMessageRow) |
| Messages | dynamic: `${escapeHtml(msg.subject \|\| 'No subject')}` | `frontend/app.js:867` (renderMessageRow) |
| Messages | dynamic: `${escapeHtml(msg.recipient \|\| '')}` | `frontend/app.js:872` (renderMessageRow) |
...
| Security | dynamic: `Unban ${escapeHtml(log.ip)}/32` | `frontend/app.js:995` (renderNetfilterData) |
| Security | dynamic: `Ban ${escapeHtml(log.ip)}/32` | `frontend/app.js:996` (renderNetfilterData) |
| Security | dynamic: `Unban ${escapeHtml(src.ip)}/32` | `frontend/app.js:1169` (renderSecurityOverview) |
| Security | dynamic: `Ban ${escapeHtml(src.ip)}/32` | `frontend/app.js:1171` (renderSecurityOverview) |
| Security | dynamic: `Never ban ${escapeHtml(src.ip)}/32` | `frontend/app.js:1172` (renderSecurityOverview) |
| Security | dynamic: `${escapeHtml(where)}` | `frontend/app.js:1177` (renderSecurityOverview) |
| Security | dynamic: `${escapeHtml(formatTime(src.last_seen))}` | `frontend/app.js:1181` (renderSecurityOverview) |
| Security | dynamic: `${escapeHtml(formatTime(row.time))}` | `frontend/app.js:1197` (renderSecurityOverview) |
...
| Queue | "Retry delivery of every message in the queue" | `frontend/app.js:2529` (applyQueueFilters) |
| Queue | dynamic: `Suppress ${escapeHtml(recipients[0].email)}` | `frontend/app.js:2552` (applyQueueFilters) |
| Queue | dynamic: `${escapeHtml(formatTime(queued))}` | `frontend/app.js:2559` (applyQueueFilters) |
| Queue | "Retry delivery" | `frontend/app.js:2568` (applyQueueFilters) |
| Queue | "Release from hold" | `frontend/app.js:2570` (applyQueueFilters) |
| Queue | "Hold message" | `frontend/app.js:2571` (applyQueueFilters) |
| Queue | "Delete from queue" | `frontend/app.js:2572` (applyQueueFilters) |
| Quarantine | "View details" | `frontend/app.js:2851` (renderQuarantineData) |
| Quarantine | dynamic: `${escapeHtml(formatTime(item.created))}` | `frontend/app.js:2857` (renderQuarantineData) |
| Quarantine | "Release message" | `frontend/app.js:2860` (renderQuarantineData) |
| Quarantine | "Delete message" | `frontend/app.js:2861` (renderQuarantineData) |
| Quarantine | "Release & train as Not Spam" | `frontend/app.js:2864` (renderQuarantineData) |
| Quarantine | "Delete & train as Spam" | `frontend/app.js:2865` (renderQuarantineData) |
| Quarantine | "Create auto-rule from this email" | `frontend/app.js:2866` (renderQuarantineData) |
| Quarantine | "View details" | `frontend/app.js:2867` (renderQuarantineData) |
| Quarantine | "Close" | `frontend/app.js:3015` (showQuarantineDetails) |
| Quarantine | dynamic: `${escapeHtml(opts)}` | `frontend/app.js:3072` (renderQuarantineDetailContent) |
| Quarantine | "Delete & train as Spam" | `frontend/app.js:3122` (renderQuarantineDetailContent) |
| Quarantine | "Release & train as Not Spam" | `frontend/app.js:3123` (renderQuarantineDetailContent) |
| Quarantine | dynamic: `${rule.enabled ? 'Click to disable this rule' : 'Click to enable this rule'}` | `frontend/app.js:3184` (loadQuarantineRules) |
| Quarantine | "Edit" | `frontend/app.js:3186` (loadQuarantineRules) |
| Quarantine | "Delete" | `frontend/app.js:3187` (loadQuarantineRules) |
| Quarantine | "Close" | `frontend/app.js:3243` (_showQuarantineRuleModal) |
| Quarantine | dynamic: `${escapeHtml(m.subject \|\| '')}` | `frontend/app.js:3431` (testQuarantineRules) |
| Quarantine | "Close" | `frontend/app.js:3455` (testQuarantineRules) |
| Quarantine | dynamic: `${escapeHtml(log.sender \|\| '')} → ${escapeHtml(log.recipient \|\| '')}` | `frontend/app.js:3507` (loadQuarantineRuleHistory) |
| Quarantine | dynamic: `Rule: ${escapeHtml(log.rule_name \|\| '')}` | `frontend/app.js:3508` (loadQuarantineRuleHistory) |
...
| Status | dynamic: `${escapeHtml(title)}` | `frontend/app.js:3889` (loadStatusContainers) |
| Status | dynamic: `${escapeHtml(detail(r))}` | `frontend/app.js:4265` (renderBlacklistStatus) |
| Status | dynamic: `${host.checked_at ? escapeHtml(formatTime(host.checked_at)) : ''}` | `frontend/app.js:4267` (renderBlacklistStatus) |
| Status | "Run Check for this Host" | `frontend/app.js:4269` (renderBlacklistStatus) |
| Status | dynamic: `${escapeHtml(detail(r))}` | `frontend/app.js:4278` (renderBlacklistStatus) |
| Status | dynamic: `${d.last_fetch_run ? escapeHtml(formatTime(d.last_fetch_run)) : ''}` | `frontend/app.js:4294` (renderStatusImport) |
| Status | dynamic: `${d.last_import ? escapeHtml(formatTime(d.last_import)) : ''}` | `frontend/app.js:4295` (renderStatusImport) |
...
| Logs | "Pause/Resume live updates" | `frontend/index.html:1307` |
| Logs | "Live mode - show latest logs" | `frontend/index.html:1311` |
| Logs | "Auto-scroll to new entries" | `frontend/index.html:1314` |
| Logs | "Toggle sort order (newest at bottom / newest at top)" | `frontend/index.html:1317` |
| Logs | "Toggle word wrap" | `frontend/index.html:1328` |
| Logs | "Clear display" | `frontend/index.html:1331` |
| Logs | "Search" | `frontend/index.html:1338` |
| Logs | "Clear search" | `frontend/index.html:1339` |
...
| Modal: changelog-modal | "Close" | `frontend/index.html:1439` |
| Modal: container-logs-modal | "Refresh" | `frontend/index.html:497` |
| Modal: container-logs-modal | "Close" | `frontend/index.html:505` |
| Modal: dmarc-reports-management-modal | "Close" | `frontend/index.html:1487` |
| Modal: dmarc-sync-history-modal | "Close" | `frontend/index.html:1474` |
| Modal: message-modal | "Close" | `frontend/index.html:1412` |
...
| Page | What | Code |
|---|---|---|
| Messages | "Please select both start and end dates" [warning] | `frontend/app.js:3625` (applyMessagesCustomDateRange) |
| Messages | "Start date must be before end date" [warning] | `frontend/app.js:3634` (applyMessagesCustomDateRange) |
| Security | "IP ' + ip + ' unbanned successfully" [success] | `frontend/app.js:1023` (unbanIP) |
| Security | dynamic: `'Failed to unban: ' + (result.msg \|\| result.detail \|\| 'Unknown error')` [error] | `frontend/app.js:1030` (unbanIP) |
| Security | dynamic: `'Failed to unban IP: ' + err.message` [error] | `frontend/app.js:1037` (unbanIP) |
| Security | dynamic: ``IP ${ip} added to blacklist`` [success] | `frontend/app.js:1064` (banIP) |
| Security | dynamic: `'Failed to ban: ' + (result.msg \|\| result.detail \|\| 'Unknown error')` [error] | `frontend/app.js:1071` (banIP) |
| Security | dynamic: `'Failed to ban IP: ' + err.message` [error] | `frontend/app.js:1078` (banIP) |
| Security | "Failed to dismiss alert" [error] | `frontend/app.js:1731` (acknowledgeSecurityAlert) |
| Security | "All security alerts dismissed" [success] | `frontend/app.js:1739` (acknowledgeAllSecurityAlerts) |
| Security | "Failed to dismiss alerts" [error] | `frontend/app.js:1741` (acknowledgeAllSecurityAlerts) |
| Security | "Fail2Ban settings saved successfully" [success] | `frontend/app.js:2350` (loadFail2BanSettings) |
| Security | dynamic: `'Failed to save Fail2Ban settings: ' + (result.msg \|\| result.detail \|\| 'U...` [error] | `frontend/app.js:2354` (loadFail2BanSettings) |
| Security | dynamic: `'Failed to save Fail2Ban settings: ' + err.message` [error] | `frontend/app.js:2357` (loadFail2BanSettings) |
| Security | "Fail2Ban IP lists saved successfully" [success] | `frontend/app.js:2403` (loadFail2BanSettings) |
| Security | dynamic: `'Failed to save Fail2Ban IP lists: ' + (result.msg \|\| result.detail \|\| 'U...` [error] | `frontend/app.js:2406` (loadFail2BanSettings) |
| Security | dynamic: `'Failed to save Fail2Ban IP lists: ' + err.message` [error] | `frontend/app.js:2409` (loadFail2BanSettings) |
...
| Queue | dynamic: `result.msg \|\| `${labels[action] \|\| action} completed`` [success] | `frontend/app.js:2676` (queueAction) |
| Queue | dynamic: ``Queue action failed: ` + (result.msg \|\| result.detail \|\| 'Unknown error')` [error] | `frontend/app.js:2680` (queueAction) |
| Queue | dynamic: ``Queue action failed: ` + err.message` [error] | `frontend/app.js:2683` (queueAction) |
| Queue | dynamic: `result.msg \|\| 'Message deleted from queue'` [success] | `frontend/app.js:2703` (queueDeleteRequest) |
| Queue | dynamic: `'Failed to delete from queue: ' + (result.msg \|\| result.detail \|\| 'Unknow...` [error] | `frontend/app.js:2707` (queueDeleteRequest) |
| Queue | dynamic: `'Failed to delete from queue: ' + err.message` [error] | `frontend/app.js:2710` (queueDeleteRequest) |
| Quarantine | dynamic: `result.msg \|\| `Message(s) ${actionLabels[action] \|\| action} successfully`` [success] | `frontend/app.js:2986` (quarantineAction) |
| Quarantine | dynamic: ``Failed to ${action} message(s): ` + (result.msg \|\| result.detail \|\| 'Unk...` [error] | `frontend/app.js:2990` (quarantineAction) |
| Quarantine | dynamic: ``Failed to ${action} message(s): ` + err.message` [error] | `frontend/app.js:2993` (quarantineAction) |
| Quarantine | "Rule not found" [error] | `frontend/app.js:3203` (showEditQuarantineRuleModal) |
| Quarantine | "Rule name is required" [error] | `frontend/app.js:3336` (saveQuarantineRule) |
| Quarantine | "Match value is required" [error] | `frontend/app.js:3337` (saveQuarantineRule) |
| Quarantine | dynamic: `isEdit ? 'Rule updated' : 'Rule created'` [success] | `frontend/app.js:3369` (saveQuarantineRule) |
| Quarantine | dynamic: `'Failed to save rule: ' + err.message` [error] | `frontend/app.js:3372` (saveQuarantineRule) |
| Quarantine | "Rule deleted" [success] | `frontend/app.js:3383` (deleteQuarantineRule) |
| Quarantine | dynamic: `'Failed to delete rule: ' + err.message` [error] | `frontend/app.js:3386` (deleteQuarantineRule) |
| Quarantine | dynamic: ``Rule ${rule.enabled ? 'enabled' : 'disabled'}`` [success] | `frontend/app.js:3396` (toggleQuarantineRule) |
| Quarantine | dynamic: `'Failed to toggle rule: ' + err.message` [error] | `frontend/app.js:3399` (toggleQuarantineRule) |
| Quarantine | "Testing rules against quarantine..." [info] | `frontend/app.js:3405` (testQuarantineRules) |
| Quarantine | dynamic: ``No matches found (${data.total_quarantine} quarantine items checked)`` [info] | `frontend/app.js:3412` (testQuarantineRules) |
| Quarantine | dynamic: `'Test failed: ' + err.message` [error] | `frontend/app.js:3472` (testQuarantineRules) |
...
| Status | "Starting blacklist check..." [info] | `frontend/app.js:4056` (checkBlacklists) |
| Status | "Blacklist check completed" [success] | `frontend/app.js:4100` (checkBlacklists) |
| Status | dynamic: ``Check completed for ${host}`` [success] | `frontend/app.js:4128` (checkBlacklists) |
| Status | dynamic: ``Failed to check: ${error.message}`` [error] | `frontend/app.js:4137` (checkBlacklists) |
| Status | dynamic: ``Job "${displayName}" started successfully`` [success] | `frontend/app.js:4458` (triggerBackgroundJob) |
| Status | dynamic: ``Job "${displayName}" is already running`` [warning] | `frontend/app.js:4467` (triggerBackgroundJob) |
| Status | dynamic: ``Failed to start job: ${error.message}`` [error] | `frontend/app.js:4470` (triggerBackgroundJob) |
...
| app.js (mixed) | dynamic: ``IP ${ip} added to the allowlist`` [success] | `frontend/app.js:1221` (allowIP) |
| app.js (mixed) | dynamic: `'Failed to allow: ' + (result.msg \|\| result.detail \|\| 'Unknown error')` [error] | `frontend/app.js:1227` (allowIP) |
| app.js (mixed) | dynamic: `'Failed to allow IP: ' + err.message` [error] | `frontend/app.js:1229` (allowIP) |
...
| Page | What | Code |
|---|---|---|
| Security | showConfirmModal: dynamic: `{ title: 'Unban IP', message: 'Unban IP ' + ipWithMask + '?', confirmText: 'U...` | `frontend/app.js:1010` (unbanIP) |
| Security | showConfirmModal: dynamic: `{ title: 'Ban IP', message: `Are you sure you want to permanently ban ${ipWit...` | `frontend/app.js:1047` (banIP) |
...
| Queue | showConfirmModal: dynamic: `{ title: 'Retry Delivery', message: `Retry delivery of ${ids.length} message(...` | `frontend/app.js:2622` (queueBulkRetry) |
| Queue | showConfirmModal: dynamic: `{ title: 'Delete Messages', message: `Permanently delete ${ids.length} messag...` | `frontend/app.js:2629` (queueBulkDelete) |
| Queue | showConfirmModal: dynamic: `{ title: 'Delete Message', message: 'Delete this message from the queue?', co...` | `frontend/app.js:2648` (queueDeleteItem) |
| Queue | showConfirmModal: dynamic: `{ title: 'Flush Queue', message: 'Flush (retry delivery of) ALL messages in t...` | `frontend/app.js:2653` (queueFlushAll) |
| Queue | showConfirmModal: dynamic: `{ title: 'Delete All', message: 'Permanently delete ALL messages from the que...` | `frontend/app.js:2658` (queueDeleteAll) |
| Quarantine | showConfirmModal: dynamic: `{ title: 'Delete Message', message: 'Are you sure you want to permanently del...` | `frontend/app.js:2909` (quarantineDelete) |
| Quarantine | showConfirmModal: dynamic: `{ title: 'Not Spam', message: 'Release this message and train Rspamd that it ...` | `frontend/app.js:2914` (quarantineLearnHam) |
| Quarantine | showConfirmModal: dynamic: `{ title: 'Mark as Spam', message: 'Delete this message and train Rspamd that ...` | `frontend/app.js:2919` (quarantineLearnSpam) |
| Quarantine | showConfirmModal: dynamic: `{ title: 'Release Messages', message: `Release ${ids.length} quarantined mess...` | `frontend/app.js:2926` (quarantineBulkRelease) |
| Quarantine | showConfirmModal: dynamic: `{ title: 'Delete Messages', message: `Permanently delete ${ids.length} quaran...` | `frontend/app.js:2933` (quarantineBulkDelete) |
| Quarantine | showConfirmModal: dynamic: `{ title: 'Not Spam', message: `Release ${ids.length} message(s) and train Rsp...` | `frontend/app.js:2940` (quarantineBulkLearnHam) |
| Quarantine | showConfirmModal: dynamic: `{ title: 'Mark as Spam', message: `Delete ${ids.length} message(s) and train ...` | `frontend/app.js:2947` (quarantineBulkLearnSpam) |
| Quarantine | showConfirmModal: dynamic: `{ title: 'Release All', message: `Release ALL ${allIds.length} quarantined me...` | `frontend/app.js:2954` (quarantineReleaseAll) |
| Quarantine | showConfirmModal: dynamic: `{ title: 'Delete All', message: `Permanently delete ALL ${allIds.length} quar...` | `frontend/app.js:2961` (quarantineDeleteAll) |
| Quarantine | showConfirmModal: dynamic: `{ title: 'Delete Rule', message: `Delete rule "${ruleName}"?`, confirmText: '...` | `frontend/app.js:3377` (deleteQuarantineRule) |
...
| Security | getFlagUrl(log.country_code, '16x12') | `frontend/app.js:973` (renderNetfilterData) |
| Security | getFlagUrl(d.country_code, '24x18') | `frontend/app.js:1906` (loadSecurityCountryChart) |
| Shared | getFlagUrl(rspamdData.country_code, size) | `frontend/app.js:4542` (renderGeoIPInfo) |
| Shared | getFlagUrl(record.country_code, size) | `frontend/app.js:4585` (renderGeoIPForDMARC) |
...
| Modal: changelog-modal | renders `markdownContent` | `frontend/app.js:648` (showMarkdownModal) |
| Modal: changelog-modal | renders `changelog` | `frontend/app.js:4498` (showChangelogModal) |
...
| Messages | click on `document` | `frontend/app.js:3655` |
...
| Security | click on `editSettingsBtn` | `frontend/app.js:2288` (loadFail2BanSettings) |
| Security | click on `editIpBtn` | `frontend/app.js:2304` (loadFail2BanSettings) |
| Security | submit on `settingsForm` | `frontend/app.js:2315` (loadFail2BanSettings) |
| Security | submit on `ipForm` | `frontend/app.js:2368` (loadFail2BanSettings) |
...
| app.js (mixed) | click on `changelogModal` | `frontend/app.js:4693` |
| app.js (mixed) | click on `changelogContent` | `frontend/app.js:4701` |
...
| Logs | `logs-fontsize`: 10px / 11px / 12px / 13px / 14px / 16px | `frontend/index.html:1320` |
...
| Page | What | Code |
|---|---|---|
| Security | bar chart on `ctx` | `frontend/app.js:1997` (loadSecurityCountryChart) |
...
| Page | What | Code |
|---|---|---|
| Shell | "No changelog available" | `frontend/app.js:629` (loadAppVersionStatus) |
| Shell | "No changelog available" | `frontend/app.js:690` (loadMailcowVersionStatus) |
| Dashboard | "No blacklist data yet" | `frontend/app.js:4190` (loadDashboardBlacklistSummary) |
| Messages | "No messages found" | `frontend/app.js:891` (renderMessagesData) |
| Messages | "No messages found" | `frontend/app.js:3775` (loadMessages) |
...
| Security | "No logs found" | `frontend/app.js:928` (renderNetfilterData) |
| Security | "No matching entries" | `frontend/smtp-abuse.js:137` (renderSmtpAbusePanel) |
| Queue | "No matching queue entries" | `frontend/app.js:2508` (applyQueueFilters) |
| Quarantine | "No quarantined messages" | `frontend/app.js:2814` (renderQuarantineData) |
| Quarantine | "No actions recorded yet" | `frontend/app.js:3500` (loadQuarantineRuleHistory) |
| Status | "No container information available" | `frontend/app.js:3900` (loadStatusContainers) |
| Status | "No changelog available" | `frontend/app.js:3935` (loadStatusSystem) |
...
| Modal: changelog-modal | "No changelog available" | `frontend/app.js:4500` (showChangelogModal) |
| Modal: container-logs-modal | "No logs available" | `frontend/app.js:4776` (fetchContainerLogs) |
...
| Page | What | Code |
|---|---|---|
| Messages | 1 loading indicator(s) | `frontend/app.js:3739` (loadMessages) |
| Message details | 1 loading indicator(s) | `frontend/message-details.js:99` (viewMessageDetails) |
| Security | 1 loading indicator(s) | `frontend/app.js:2090` (loadNetfilterLogs) |
| Queue | 1 loading indicator(s) | `frontend/app.js:2440` (loadQueue) |
| Quarantine | 1 loading indicator(s) | `frontend/app.js:2765` (loadQuarantine) |
| Quarantine | 1 loading indicator(s) | `frontend/app.js:3492` (loadQuarantineRuleHistory) |
| Status | 2 loading indicator(s) | `frontend/app.js:4048` (checkBlacklists) |
| Status | 1 loading indicator(s) | `frontend/app.js:4445` (triggerBackgroundJob) |
...
| Page | What | Code |
|---|---|---|
| Shell | localStorage getItem "theme" | `frontend/app.js:4651` (initDarkMode) |
| Shell | localStorage setItem "theme" | `frontend/app.js:4666` (toggleDarkMode) |
...
| Shell | every AUTO_REFRESH_INTERVAL ms | `frontend/app.js:749` (startAutoRefresh) |
| Status | every 1000 ms | `frontend/app.js:4083` (checkBlacklists) |
| Settings | every 2000 ms | `frontend/settings.js:1630` (showGeoIPSetupModal) |
| Modal: container-logs-modal | every 2000 ms | `frontend/app.js:4812` (loadContainerLogs) |
...
| Modal: changelog-modal | keydown: Escape | `frontend/app.js:4681` |
